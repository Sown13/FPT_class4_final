                    ...
                    <tbody class="table-group-divider">
                        {productList.map((product, index) => (
                            <tr key={index}>
                                ...
                                <td className="row">
                                    <button className="btn btn-primary col-6"><i class="fa-solid fa-wrench"></i></button>
                                    <button className="btn col-6" style={{ backgroundColor: "red", borderColor: "white" }}><i class="fa-solid fa-trash"></i></button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
